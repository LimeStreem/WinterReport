...
namespace CalculationMathematicsReport.Compute
{
    public class ReadableVectorTexture:IDisposable
    {
        ...
        public VectorTextureDataWrapper MapResource()
        {
            ...
            var mapSubresource = _device.ImmediateContext.MapSubresource(StagingUsageTexture1D,0,0, MapMode.Read, MapFlags.None);
        ...
        public Vector ToVector()
        {
            ...
            Vector ret=new Vector(new BasicVectorElementBuilder(_width,(i)=>data[i]));
            UnMapResource();
            return ret;
        }
